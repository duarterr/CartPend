...
#define ENCODER_T_QEI_PERIPH    SYSCTL_PERIPH_QEI1     // QEI peripheral for Theta encoder
#define ENCODER_T_GPIO_PERIPH   SYSCTL_PERIPH_GPIOC    // GPIO peripheral for Theta encoder
#define ENCODER_T_QEI_BASE      QEI1_BASE              // Base address for Theta QEI module
#define ENCODER_T_GPIO_BASE     GPIO_PORTC_BASE        // Base address for Theta GPIO port
#define ENCODER_T_A_CFG         GPIO_PC5_PHA1          // Pin mux configuration for Theta encoder Phase A
#define ENCODER_T_B_CFG         GPIO_PC6_PHB1          // Pin mux configuration for Theta encoder Phase B
#define ENCODER_T_A_PIN         GPIO_PIN_5             // Theta encoder Phase A pin
#define ENCODER_T_B_PIN         GPIO_PIN_6             // Theta encoder Phase B pin
#define ENCODER_T_CFG           QEI_CONFIG_NO_SWAP     // Theta encoder configuration

// Encoder defines - X
#define ENCODER_X_QEI_PERIPH    SYSCTL_PERIPH_QEI0     // QEI peripheral for X encoder
#define ENCODER_X_GPIO_PERIPH   SYSCTL_PERIPH_GPIOD    // GPIO peripheral for X encoder
#define ENCODER_X_QEI_BASE      QEI0_BASE              // Base address for X QEI module
#define ENCODER_X_GPIO_BASE     GPIO_PORTD_BASE        // Base address for X GPIO port
#define ENCODER_X_A_CFG         GPIO_PD6_PHA0          // Pin mux configuration for X encoder Phase A
#define ENCODER_X_B_CFG         GPIO_PD7_PHB0          // Pin mux configuration for X encoder Phase B
#define ENCODER_X_A_PIN         GPIO_PIN_6             // X encoder Phase A pin
#define ENCODER_X_B_PIN         GPIO_PIN_7             // X encoder Phase B pin
#define ENCODER_X_CFG           QEI_CONFIG_NO_SWAP     // X encoder configuration
